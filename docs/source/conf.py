...
sys.path.insert( 0, os.path.abspath('../../FlatSkyLab/') ) #this is important to point out that the codes are outisde of the docs folder.

project = 'FlatSkyLab analysis software'
